...
[param, pairsUsed, estimationErrors] = my_estimateCameraParameters(imagePoints, worldPoints, ...
    ...
    'InitialIntrinsicMatrix', intrinsicMatrix, 'InitialIntrinsicMatrix2', intrinsicMatrix1, ...
    'InitialRadialDistortion', radialDistortion, 'InitialRadialDistortion2', radialDistortion1);
