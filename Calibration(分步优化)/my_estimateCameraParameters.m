...
cameraModel.NumRadialDistortionCoefficients = 2;
    ...
    calibrationParams1.initIntrinsics=intrinsicMatrix;
    calibrationParams1.initRadial=radialDistortion;
...
parser.addParameter('InitialIntrinsicMatrix2', intrinsicMatrix, @checkInitialIntrinsicMatrix);
parser.addParameter('InitialRadialDistortion', radialDistortion1, @checkInitialRadialDistortion);
parser.addParameter('InitialRadialDistortion2', radialDistortion, @checkInitialRadialDistortion);
